...
a){return a+1+") "+c.toString()}).join("\n  "):"";this.name="UnsubscriptionError";this.errors=a;return this}b.prototype=Object.create(Error.prototype);return b}(),q=function(){function b(a){this.closed=!1;this._subscriptions=this._parentOrParents=null;a&&(this._ctorUnsubscribe=!0,this._unsubscribe=a)}b.prototype.unsubscribe=function(){var a;if(!this.closed){var c=this._parentOrParents,d=this._ctorUnsubscribe,e=this._unsubscribe,f=this._subscriptions;this.closed=!0;this._subscriptions=this._parentOrParents=
null;if(c instanceof b)c.remove(this);else if(null!==c)for(var k=0;k<c.length;++k)c[k].remove(this);if(T(e)){d&&(this._unsubscribe=void 0);try{e.call(this)}catch(v){a=v instanceof fa?Wa(v.errors):[v]}}if(z(f))for(k=-1,c=f.length;++k<c;)if(d=f[k],za(d))try{d.unsubscribe()}catch(v){a=a||[],v instanceof fa?a=a.concat(Wa(v.errors)):a.push(v)}if(a)throw new fa(a);}};b.prototype.add=function(a){var c=a;if(!a)return b.EMPTY;switch(typeof a){case "function":c=new b(a);case "object":if(c===this||c.closed||
